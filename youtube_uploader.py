...
Adapted from TOP5CRYPTOS uploader for @StarDriftMusic channel.
"""
...
class YouTubeUploader:
    ...
    def __init__(self):
        ...
        self.channel_name = os.getenv('YOUTUBE_CHANNEL_NAME', 'StarDriftMusic')
        self.privacy_status = os.getenv('YOUTUBE_PRIVACY', 'public')
        self.category_id = os.getenv('YOUTUBE_CATEGORY', '10')  # 10 = Music
        self.default_tags = os.getenv('YOUTUBE_TAGS', 'music,electronic,shorts,stardrift').split(',')
    ...
    def _post_early_comment(self, video_id: str) -> None:
        """Post a comment linking to the full track — non-fatal."""
        text = (
            "Full track on @official_stardrift — subscribe for more music!\n\n"
    ...
    def _generate_metadata(self, video_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        artist = video_data.get('artist', 'Star Drift')
        ...
        description += (
            f"Full track: https://www.youtube.com/@official_stardrift\n\n"
            f"#music #{genre.lower()} #shorts #electronic #stardrift #musicvideo"
        )

        tags = [
            track_name, artist, genre.lower(), 'music', 'shorts',
            'electronic', 'music video', 'visualizer', 'stardrift',
        ]
