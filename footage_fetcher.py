...
PEXELS_SUBJECT_KEYWORDS = [
    ...
    "girl walking city lights",
    "woman portrait wind hair",
    "woman spinning dress field",
    "woman sunset silhouette",
    "woman looking out window",
    "woman beach waves hair",
    "friends dancing rooftop party",
    "woman headphones dancing street",
...
PEXELS_MOOD_SUBJECT_KEYWORDS = {
    ...
    "rnb": [
        ...
        "person rooftop neon",
        "woman slow dancing neon",
        "woman looking at mirror lights",
    ],
    "electronic": [
        "person dancing club lights",
        "crowd festival lights",
        "person walking neon tunnel",
        "woman dancing laser lights",
        "woman neon body paint",
    ],
    "dark": [
        "person walking empty street night",
        "person silhouette red light",
        "person standing in fog",
        "woman silhouette dark window",
        "woman walking dark alley rain",
    ],
}
