...
PEXELS_KEYWORDS = {
    "electronic": [
        ...
        "jellyfish neon glow", "electric eel underwater", "firefly night macro",
        "drone light show night", "robot arms factory", "tesla coil electricity",
        "fiber optic lights", "satellite earth orbit", "city drone aerial night",
    ],
    "hype": [
        ...
        "cheetah running slow motion", "bull charging rodeo", "hawk diving prey",
        "volcano eruption aerial", "avalanche mountain",
    ],
    "chill": [
        ...
        "whale underwater ocean", "sea turtle swimming", "deer forest morning",
        "butterfly flower macro", "birds flying sunset", "dog running beach",
        "fish coral reef", "eagle soaring mountains",
        "bonsai tree timelapse", "cloud formation timelapse", "river aerial drone",
        "flower blooming timelapse", "hot air balloon sunrise",
        "starfish tide pool", "jellyfish aquarium blue",
    ],
    "lofi": [
        ...
        "cat sleeping window", "koi fish pond", "rabbit garden",
        "fireflies night forest", "birds morning garden",
    ],
    "rnb": [
        ...
        "swan lake sunset", "cat eyes close up dark", "moonlight ocean waves",
        "rose petals falling slow motion", "silk fabric flowing wind",
    ],
    "phonk": [
        ...
        "pitbull slow motion", "crow dark sky", "scorpion desert macro",
        "muscle car burnout", "fighter jet cockpit", "samurai sword sparks",
    ],
    "trap": [
    ...
    "psychedelic": [
        ...
        "chameleon changing color", "peacock feathers close up", "octopus color change",
        "parrot tropical colorful", "coral reef colorful fish",
    ],
    "trippy": [
        ...
        "ferrofluid magnet", "mercury liquid metal", "plasma ball electricity",
        "macro eye iris detail", "wax melting candle timelapse",
        "water droplet crown splash", "sand art flowing", "magnetic putty",
        "cymatics sound vibration", "supercell thunderstorm timelapse",
        "snowflake forming macro", "ice crystals growing timelapse",
        "paint explosion high speed", "glass shattering slow motion",
        "dandelion seeds blowing wind", "spider web dew drops macro",
    ],
    "dark": [
        ...
        "wolf dark forest", "raven flying dark sky", "snake slow motion",
        "shark underwater dark", "panther walking night",
    ],
    "rock": [
        ...
        "eagle soaring canyon", "wild mustang running", "lava flowing volcano",
        "lightning desert night", "waterfall drone aerial", "cliff diving ocean",
    ],
    "ambient": [
        ...
        "whale underwater slow motion", "manta ray swimming", "jellyfish aquarium",
        "owl night forest", "wolf howling moon", "bear river salmon",
        "dolphin jumping ocean", "hummingbird flower slow motion",
        "nebula space zoom", "drone above clouds", "glacier calving ice",
        "lava meeting ocean steam", "lightning supercell timelapse",
        "bioluminescent waves beach night", "sunrise drone mountain peak",
        "snowfall slow motion forest", "fog rolling over valley timelapse",
    ],
    "orchestral": [
    ...
    "default": [
        ...
        "lion slow motion", "horse galloping field", "elephant walking savanna",
        "bird flock murmuration", "tiger walking jungle", "fox snow forest",
        "lava flowing close up", "ice cave blue light", "drone over mountains",
        "sand dunes aerial", "meteor shower night sky", "tornado storm chaser",
        "underwater cave diving", "drone over waterfall", "time lapse city day night",
        "ferris wheel night lights", "train crossing bridge aerial",
        "glass sphere reflection", "paint mixing satisfying", "domino chain reaction",
    ],
}
...
PEXELS_SUBJECT_KEYWORDS = [
    ...
    "friends dancing rooftop party",
    "cinematic slow motion walk",
    "silhouette sunset walking",
    "drone following person city",
    "person rooftop overlooking city",
    "pov walking through market",
    "couple walking city night lights",
    "dancer silhouette spotlight",
    "person skateboarding city sunset",
    "person running through rain",
    "fashion model editorial cinematic",
    "model walking runway slow motion",
    "aesthetic portrait golden hour",
    "cinematic portrait neon light",
    "lifestyle city night aesthetic",
    "cinematic b roll urban",
    "slow motion hair flip wind",
    "person pool underwater cinematic",
    "model posing studio lights",
    "dancer contemporary slow motion",
    "aerial person walking beach",
    "person motorcycle sunset highway",
    "luxury lifestyle cinematic",
    "person standing rain cinematic",
]

PEXELS_MOOD_SUBJECT_KEYWORDS = {
    "chill": [
        "person watching sunset ocean",
        "person headphones beach golden hour",
        "friends convertible sunset drive",
        "person hammock tropical",
        "couple walking pier sunset",
        "person surfing slow motion",
        "person floating pool summer",
    ],
    "lofi": [
        "person studying headphones night",
        "person coffee shop window rain",
        "person bedroom fairy lights",
        "person painting canvas studio",
        "person vinyl record player",
        "person journaling cafe aesthetic",
    ],
    "rnb": [
        "couple dancing slow city night",
        "silhouette dancing slow spotlight",
        "person rooftop city lights neon",
        "couple dinner candlelight cinematic",
        "person driving convertible night city",
        "aesthetic portrait moody lighting",
    ],
    "electronic": [
        "person dancing club neon lights",
        "crowd festival stage lights",
        "person walking neon tunnel",
        "dj mixing console close up",
        "dancer led lights performance",
        "person vr headset neon",
    ],
    "dark": [
        "person walking empty street night rain",
        "silhouette person red light smoke",
        "person standing fog cinematic",
        "person hooded walking dark alley",
        "candlelight face dark room",
        "person staring out window storm",
    ],
    "phonk": [
        "person drifting car smoke night",
        "pov driving fast night city",
        "person boxing gym training",
        "person walking tunnel dark",
        "motorcycle rider night highway",
    ],
    "trap": [
        "person luxury car city night",
        "person penthouse city view",
        "person walking downtown night",
        "person jewelry close up cinematic",
        "crowd nightclub vip",
    ],
    "hype": [
        "crowd cheering stadium slow motion",
        "athlete celebration slow motion",
        "person cliff jumping ocean",
        "skateboarder trick slow motion",
        "person crowd surfing concert",
    ],
    "ambient": [
        "person standing mountain peak sunrise",
        "person stargazing night sky",
        "person kayaking calm lake fog",
        "person meditating nature",
        "person walking forest light rays",
    ],
    "psychedelic": [
        "person body paint uv light",
        "dancer colorful powder slow motion",
        "person festival face paint",
        "person walking mirror room",
        "person spinning sparklers night",
    ],
    "trippy": [
        "person walking kaleidoscope tunnel",
        "dancer double exposure",
        "person prism light face",
        "person spinning umbrella rain lights",
        "person smoke slow motion colorful",
    ],
}
...
def _pexels_search(query: str, per_page: int = 10,
    ...
    """Search Pexels for videos matching query. Rotates page daily for variety."""
